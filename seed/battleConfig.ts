...
export const samplePlayerHeroes : LooseObject = {
  '1': { name: 'hero1', level: 5, attack: 10, defense: 10, health: 100, maxHealth: 100, speed: 50, heroId: '1', effects: [], moveSet: [] },
  '2': { name: 'hero2', level: 20, attack: 15, defense: 15, health: 150, maxHealth: 150, speed: 25, heroId: '2', effects: [], moveSet: [] },
  '3': { name: 'hero3', level: 50, attack: 20, defense: 20, health: 200, maxHealth: 200, speed: 15, heroId: '3', effects: [], moveSet: [] }
}

export const sampleEnemyHeroes : LooseObject = {
  '3': { name: 'enemy1', level: 5, attack: 10, defense: 10, health: 100, maxHealth: 100, speed: 10, heroId: '3', effects: [], moveSet: [] },
  '4': { name: 'enemy2', level: 20, attack: 15, defense: 15, health: 150, maxHealth: 150, speed: 5, heroId: '4', effects: [], moveSet: [] },
  '5': { name: 'enemy3', level: 50, attack: 20, defense: 20, health: 200, maxHealth: 200, speed: 1, heroId: '5', effects: [], moveSet: [] }
}
